...
## Reflections
For each reflection, first state what you noticed (1 sentence), then ask a short direct question (under 15 words). Use contractions. Sound like a thoughtful friend, not an analyst. Tag each with a topic slug in bold.
1-3 reflections depending on the day's complexity — fewer for focused days, more for scattered ones.

Example format:
- **job-search**: You kept coming back to the Overland posting but never applied. What's the hesitation?
- **tool-direction**: You split prompt-review into its own repo. Is that becoming a product?
